  ...
  module Calculator
    class Winner
      ...
      def call(winner:, looser:)
        development_coefficient = player_development_coefficient(winner.nb_matches, winner.current_elo)
        probability_of_win = player_probability_of_win(winner.current_elo, looser.current_elo)
        ::Elos::EloAfterMatch::Winner.new(current_elo: winner.current_elo).call(
