...
module SmashGg
  module Contracts
    describe TournamentsParameters do
      ...
      let(:area) { SmashGg::Entities::Area.new(coordinates: 'foo', radius: 'bar') }
      let(:dates_range) { SmashGg::Entities::DatesRange.new(before_date: 'oof', after_date: 'rab') }
      let(:game) { SmashGg::Entities::Game.new(id: 'ofo') }
